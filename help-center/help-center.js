...
(function () {
        ...
        var IC = {
          ...
          clipboard:
            '<rect x="6" y="4" width="12" height="17" rx="2"/><rect x="9" y="2.3" width="6" height="3.4" rx="1"/><line x1="8.5" y1="10.2" x2="15.5" y2="10.2"/><line x1="8.5" y1="13.7" x2="15.5" y2="13.7"/><line x1="8.5" y1="17.2" x2="12.5" y2="17.2"/>',
          layers:
            '<polygon points="12 3 21 8 12 13 3 8 12 3"/><polyline points="3 12 12 17 21 12"/><polyline points="3 16 12 21 21 16"/>',
        };
        function svg(n) {
          return (
